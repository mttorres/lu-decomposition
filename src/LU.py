...
def operation(A,B,controlCanon,saida):
    ...
    saida.write("\n")
    saida.write("Matrizes que representam as operacoes realizadas na eliminacao de Gauss: \n")
    saida.write("\n")
    saida.write("\n")
    for i in range(0,len(operacoes)):
        saida.write(str(asarray(operacoes[i])))
        saida.write("\n")
        saida.write("\n")
    saida.write("\n")
    saida.write("Matrizes que representam as permutacoes realizadas na eliminacao de Gauss: \n")
    saida.write("\n")
    saida.write("\n")
    for i in range(0,len(permutacoes)):
        saida.write(str(asarray(permutacoes[i])))
        saida.write("\n")
        saida.write("\n")
    if (len(permutacoes) == 0):
        saida.write("[]")
